...
Public repos: **11** · Private repos: **13** · Public stars: **104** · Private stars: **0** · Last sync: **2026-07-13**
<!-- PROJECTS:SUMMARY:END -->

<!-- PROJECTS:PUBLIC:START -->
| Repository | Description | Stars |
| :--- | :--- | ---: |
| **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** | Local MCP server that exposes eBay Sell APIs to AI assistants with OAuth, tool gating, and stdio/HTTP transports. | 99 |
