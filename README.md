...
Public repos: **9** · Public stars: **120** · Private repos: **14** · Last sync: **2026-08-03**
<!-- PROJECTS:SUMMARY:END -->

<!-- PROJECTS:PUBLIC:START -->
| Repository | Description | ⭐ |
| :--- | :--- | ---: |
| **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** | Local MCP server that exposes eBay Sell APIs to AI assistants with OAuth, tool gating, and stdio/HTTP transports. | 113 |
| **[launch-store](https://github.com/YosefHayim/launch-store)** | Self-hosted CLI for building, signing, and shipping Expo/React Native apps to TestFlight and Google Play. | 4 |
