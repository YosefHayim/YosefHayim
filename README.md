...
Public repos: **11** · Public stars: **155** · Private repos: **15** · Last sync: **2026-09-01**
<!-- PROJECTS:SUMMARY:END -->

<!-- PROJECTS:PUBLIC:START -->
| Repository | Description | ⭐ |
| :--- | :--- | ---: |
| **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** | Local MCP server that exposes eBay Sell APIs to AI assistants with OAuth, tool gating, and stdio/HTTP transports. | 141 |
